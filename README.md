...
| Example       | Output        |
| ------------- |:-------------:|
| ```python ALFB = ['A','B','C','D']```<br>`GetAllComb(ALFB)` | ```['ABCD', 'ABDC', 'ACBD', 'ACDB', 'ADBC', 'ADCB', 'BACD', 'BADC', 'BCAD', 'BCDA', 'BDAC', 'BDCA', 'CABD', 'CADB', 'CBAD', 'CBDA', 'CDAB', 'CDBA', 'DABC', 'DACB', 'DBAC', 'DBCA', 'DCAB', 'DCBA']``` |
